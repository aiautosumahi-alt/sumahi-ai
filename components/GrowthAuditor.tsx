    ...
    <section id="auditor" className="py-24 px-6 bg-slate-950 scroll-mt-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-8 lg:p-14 shadow-2xl border border-white/40 relative group overflow-hidden">
          ...
          <form onSubmit={handleAudit} className="relative z-10 space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-3">
                ...
                <input 
                  ...
                  className="w-full !bg-slate-950 !text-white px-6 py-4 rounded-2xl border border-white/20 placeholder:text-slate-600 focus:ring-2 focus:ring-red-600/50 focus:border-red-600/50 outline-none transition-all shadow-inner"
              ...
              <div className="space-y-3">
                ...
                <select 
                  className="w-full !bg-slate-950 !text-white px-6 py-4 rounded-2xl border border-white/20 focus:ring-2 focus:ring-red-600/50 focus:border-red-600/50 outline-none transition-all shadow-inner appearance-none cursor-pointer"
            ...
            <div className="space-y-3">
              ...
              <textarea 
                ...
                className="w-full !bg-slate-950 !text-white px-6 py-5 rounded-2xl border border-white/20 placeholder:text-slate-600 focus:ring-2 focus:ring-red-600/50 focus:border-red-600/50 outline-none transition-all h-36 resize-none shadow-inner"
          ...
          {state.result && (
            <div className="mt-14 bg-slate-950 rounded-3xl p-10 border border-white shadow-[0_0_50px_-12px_rgba(220,38,38,0.2)] animate-fade-in relative">
              <div className="absolute top-0 left-0 w-full h-1 bg-red-600/20 animate-scan"></div>
              
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 rounded-2xl bg-red-600/10 flex items-center justify-center text-red-500 border border-white/20">
              ...
              <div className="mt-12 p-8 bg-red-700 rounded-[2rem] text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden group/cta border border-white/30">
                ...
                <button 
                  ...
                  className="relative z-10 bg-white group-hover/cta:bg-red-700 text-slate-950 group-hover/cta:text-white px-10 py-4 rounded-xl font-black transition-all shadow-xl hover:scale-105 active:scale-95 shrink-0 border border-transparent group-hover/cta:border-white"
                >
                  Secure Slot
                </button>
              </div>
