...
const Hero: React.FC = () => {
  ...
  const generateCoverPhoto = async () => {
    ...
    try {
      ...
      setImageUrl("https://images.unsplash.com/photo-1614064641935-4475e8329227?auto=format&fit=crop&q=80&w=2000");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 text-left space-y-8">
            <div className="inline-flex items-center gap-3 text-red-500 font-bold tracking-[0.2em] uppercase text-xs bg-red-500/10 px-5 py-2.5 rounded-full border border-red-500/20 backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-start">
              <button 
                ...
                className="group relative bg-red-700 text-white px-10 py-5 rounded-2xl text-lg font-bold hover:bg-red-600 transition-all shadow-[0_0_50px_-10px_rgba(220,38,38,0.3)] flex items-center gap-3 overflow-hidden"
              >
              ...
              <button 
                ...
                disabled={isLoading}
                className="px-6 py-5 text-slate-400 hover:text-white transition-colors flex items-center gap-3 group"
              >
                ...
                <span className="text-sm font-bold tracking-widest uppercase">Sync Neural Visual</span>
              </button>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 relative group">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden border border-white/5 shadow-2xl aspect-[16/9] bg-slate-900">
              {isLoading ? (
