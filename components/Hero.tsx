...
const Hero: React.FC = () => {
  ...
  const generateCoverPhoto = async () => {
    setIsLoading(true);
    console.debug("Initializing neural visual sync...");
      ...
      if (response.candidates && response.candidates[0]?.content?.parts) {
        for (const part of response.candidates[0].content.parts) {
          if (part.inlineData?.data) {
            ...
            foundImage = true;
            console.debug("Neural visual sync complete.");
            break;
          }
        }
      }
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 text-left space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-start">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/20 flex items-center justify-center group-hover:bg-white/10 transition-all">
