...
const TrustSecurity: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-slate-950 overflow-hidden border-y border-white/5">
      <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3.5rem] p-12 lg:p-20 text-center text-white relative border border-white/5">
        ...
        <div className="relative z-10">
          <div className="inline-block bg-red-600/10 text-red-500 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-8 border border-red-600/20">
