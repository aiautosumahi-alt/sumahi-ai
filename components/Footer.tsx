        ...
        <div className="col-span-2">
          ...
          <div className="flex flex-col gap-4 mb-8">
            <a 
              ...
              className="flex items-center gap-3 text-emerald-400 font-bold hover:text-emerald-300 transition-colors group"
            >
              <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center group-hover:bg-emerald-500 group-hover:text-white transition-all">
