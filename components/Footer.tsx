      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
        <div className="col-span-2">
          ...
          <p className="text-slate-500 max-w-sm mb-8">
            The premium infrastructure layer for high-growth agencies. Bridging human intuition and technical intelligence.
          </p>
          <div className="flex flex-col gap-4 mb-8">
            <a 
              href="https://wa.me/918074251396" 
              className="flex items-center gap-3 text-cyan-400 font-bold hover:text-cyan-300 transition-colors group"
            >
              <div className="w-8 h-8 rounded-full bg-cyan-600/10 flex items-center justify-center group-hover:bg-cyan-600 group-hover:text-white transition-all border border-white/10">
        ...
        <div>
          <h4 className="font-bold mb-6 uppercase tracking-widest text-xs text-cyan-400">Infrastructure</h4>
